   ...
   jobs:
     opencode:
       ...
       steps:
          ...
          - name: Run opencode
            uses: anomalyco/opencode-action@latest
            env:
...
2. Run:
   ...
   MODEL=anthropic/claude-sonnet-4-20250514 \
     ...
     bun /path/to/opencode-action/index.ts
   ```
   ...
   - `/path/to/opencode-action`: Path to your cloned opencode-action repo. `bun /path/to/opencode-action/index.ts` runs your local version of `opencode`.
